...
| Restart during the day | a new process would forget today's losses and halts | persisted risk state plus REST-derived day P&L seed the strategy (`RiskStateSeed`); a daily-loss halt holds until the UTC day ends or an explicit operator reset |
